...
<body 
style="background: url(images/bank.gif);background-size: 40%">
 
<h1 class="alert alert-success rounded-0"><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:NITESH ANAND</kbd></small></h1>

<h1>Welcome to LBCC BANK</large></h1>
<br>
<?php echo $error ?>
<br>
