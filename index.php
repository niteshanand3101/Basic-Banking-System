...
<body style="background:url(images/78.gif);background-size: 40%">
...
<div class="col">
    <div class="row" style="padding: 22px;padding-top: 0">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/moneytransfer.gif" alt="Card image cap" style="max-height: 155px;min-height: 155px">
        <div class="card-body">
